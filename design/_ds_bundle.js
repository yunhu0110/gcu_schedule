/* @ds-bundle: {"format":4,"namespace":"GcuDesignSystem_9960c3","components":[{"name":"Avatar","sourcePath":"components/core/Avatar.jsx"},{"name":"Badge","sourcePath":"components/core/Badge.jsx"},{"name":"Button","sourcePath":"components/core/Button.jsx"},{"name":"Card","sourcePath":"components/core/Card.jsx"},{"name":"DdayPill","sourcePath":"components/core/DdayPill.jsx"},{"name":"GaugeCell","sourcePath":"components/core/GaugeCell.jsx"},{"name":"SectionHeader","sourcePath":"components/core/SectionHeader.jsx"},{"name":"Text","sourcePath":"components/core/Text.jsx"}],"sourceHashes":{"assets/image-slot.js":"fff26d081c8d","components/core/Avatar.jsx":"5c866dd6e48b","components/core/Badge.jsx":"7199457d7495","components/core/Button.jsx":"bfc8362347b8","components/core/Card.jsx":"dbfc054af76d","components/core/DdayPill.jsx":"6f0e050c886b","components/core/GaugeCell.jsx":"b06db7feb138","components/core/SectionHeader.jsx":"5430fe2ae793","components/core/Text.jsx":"e68df615834e"},"inlinedExternals":[],"unexposedExports":[]} */

(() => {

const __ds_ns = (window.GcuDesignSystem_9960c3 = window.GcuDesignSystem_9960c3 || {});
...
function Button({
  ...
  }, "\u2026") : /*#__PURE__*/React.createElement(React.Fragment, null, iconLeft, /*#__PURE__*/React.createElement("span", null, children), iconRight));
}
...
function DdayPill({
  ...
  let label;
  if (days === 0) label = 'D-DAY';else if (days > 0) label = `D-${days}`;else label = `D+${Math.abs(days)}`;
  const base = {
    display: 'inline-flex',
    alignItems: 'center',
    fontFamily: 'var(--font-mono)',
...
Object.assign(__ds_scope, { DdayPill });
})(); } catch (e) { __ds_ns.__errors.push({ path: "components/core/DdayPill.jsx", error: String((e && e.message) || e) }); }

// components/core/GaugeCell.jsx
try { (() => {
const SLOT_COLOR = {
...
function GaugeCell({
  ...
  const norm = slots.map(s => typeof s === 'string' ? {
    status: s
  } : s);
  ...
  const label = allAvailable ? `${day}일, 6명 모두 가능` : `${day}일, 가능 ${norm.filter(s => s.status === 'available').length}명`;
  return /*#__PURE__*/React.createElement("div", {
    ...
    style: {
      ...
      height: 4,
      borderRadius: '50%',
      background: allAvailable ? 'var(--paper)' : 'var(--cobalt)'
    }
  }), /*#__PURE__*/React.createElement("span", {
    style: numStyle
  }, day), allAvailable ? /*#__PURE__*/React.createElement("span", {
    style: {
      fontFamily: 'var(--font-mono)',
      fontSize: 8,
      letterSpacing: 1,
...
Object.assign(__ds_scope, { GaugeCell });
})(); } catch (e) { __ds_ns.__errors.push({ path: "components/core/GaugeCell.jsx", error: String((e && e.message) || e) }); }
...
const PRESETS = {
  ...
  bodySm: {
    fontFamily: 'var(--font-body)',
    fontWeight: 400,
    fontSize: 'var(--fs-bodysm)',
    lineHeight: 'var(--lh-bodysm)'
  },
  caption: {
    fontFamily: 'var(--font-body)',
    fontWeight: 400,
...
__ds_ns.DdayPill = __ds_scope.DdayPill;

__ds_ns.GaugeCell = __ds_scope.GaugeCell;
